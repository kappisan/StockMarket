...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Shockcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"shockcointools.com", "dnsseed.shockcointools.com"},
    {"shockcoinpool.org", "dnsseed.shockcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"shockcointools.com", "testnet-seed.shockcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Shockcoin is probably already running."), addrBind.ToString().c_str());
        else
